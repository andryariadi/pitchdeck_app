...
export default async function Home({ searchParams }: { searchParams: Promise<{ query?: string }> }) {
  ...
  return (
    <>
      ...
      <section className="w-full max-w-6xl mx-auto px-3 mt-10 space-y-5">
        {/* Title */}
        ...
        {/* Card */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 place-items-center gap-y-10 md:gap-14">
